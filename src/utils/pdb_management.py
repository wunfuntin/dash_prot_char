...
def get_top_pdbs_from_silent(pdb_file_list):
    ...
    silent_file_path = ('/Users/rwalker/Documents/TT_lab/python/dash_prot_char_v1_2/'
    ...
    directory_name = (f'/Users/rwalker/Documents/TT_lab/python/dash_prot_char_v1_2/silent_test_data/extracted_pdbs/'
    ...
    for pdb in pdb_file_list:
        ...
        source_file_path = '/Users/rwalker/Documents/TT_lab/python/dash_prot_char_v1_2/silent_tools/' + output_file_name
...
def get_pdb_sequences(pdb_directory):
    finish_launching(['pymol', 'cQ'])   # Launches PyMol in command line
