...
from src.utils.pdb_management import get_top_pdbs_from_silent, get_pdb_sequences
...
def get_pdb_files(pdb_list):
    if pdb_list is not None:
        ...
        parent_directory = '/Users/rwalker/Documents/TT_lab/python/dash_prot_char_v1_2/silent_test_data/extracted_pdbs'

        directory = get_most_recent_directory(parent_directory)
        get_pdb_sequences(directory)
